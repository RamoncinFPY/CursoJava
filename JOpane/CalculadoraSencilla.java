...
public class CalculadoraSencilla extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        CalculadoraSencilla calc = new CalculadoraSencilla();//Instanciamos la clase que creamos
